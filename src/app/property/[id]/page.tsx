                  ...
                  <div className="flex sm:flex-col flex-col-reverse">
                    <div className="py-3 lg:py-5 text-[14px]">
                      ...
                      <p className={`${activePlane === 2 ? "" : "hidden"}`}>
                        ...
                        ratione autem nesciunt nisi temporibus pariatur. Veniam
                        dolorem asperiores quo eum, consectetur illum in
                        sapiente molestiae quia repudiandae aspernatur hic error
                        modi vsequi quo earum nisi! Deserunt, unde totam!
                      </p>
                      <p className={`${activePlane === 3 ? "" : "hidden"}`}>
                        ...
                        enim architecto reiciendis obcaecatiDeserunt odio
