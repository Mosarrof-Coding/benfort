...
import AllProperty from "../all-property/page";
...
const Properties = () => {
  ...
  // seting page card
  const [card, setCard] = useState("search");

  // ✅ Static user info
  const user = {
    id: 1,
    name: "John Doe",
    email: "john@benfort.com",
  };

  // ✅ Static "cart" of saved properties
  const savedProperties = [
    {
      id: 201,
      title: "Luxury Loft in Downtown",
      location: "Downtown, Benfort City",
      price: 850000,
    },
    {
      id: 202,
      title: "Modern Family House",
      location: "Greenview Suburbs, Benfort",
      price: 620000,
    },
    {
      id: 203,
      title: "Penthouse with City View",
      location: "Skyline District, Benfort",
      price: 1200000,
    },
  ];
  // ✅ Calculate total value of saved properties
  const totalValue = savedProperties.reduce((sum, prop) => sum + prop.price, 0);
    ...
    <section className="">
      <div className="mx-auto px-4 max-w-[1464px]">
        <div className="flex gap-2 my-2 w-full">
          ...
          {/* pagination & profile */}
          <div
            className={`top-12 sm:top-14 md:top-16 lg:top-20 sticky flex flex-col justify-center items-center gap-2 lg:gap-4 p-1 md:p-2 lg:p-3 xl:p-5 border border-border rounded-[8px] lg:rounded-[12px] h-[88dvh] ${
              pagin
          ...
          >
            <button
              onClick={() => setCard("home")}
              className={`place-items-center grid rounded-[8px] lg:rounded-[12px] w-8 md:w-10 lg:w-12 h-8 md:h-10 lg:h-12 cursor-pointer ${
                card === "home" ? "bg-foreground" : "bg-background"
              }`}
            >
              <svg
              ...
              >
                <path
                  ...
                  fill=""
                  className={` ${
                    card === "home" ? "fill-background" : "fill-foreground"
                  }`}
                />
                <path
            ...
            <button
              onClick={() => setCard("search")}
              className={`place-items-center grid rounded-[8px] lg:rounded-[12px] w-8 md:w-10 lg:w-12 h-8 md:h-10 lg:h-12 cursor-pointer ${
                card === "search" ? "bg-foreground" : "bg-background"
              }`}
            >
              <svg
                className="w-5 lg:w-6"
              ...
              >
                <g clipPath="url(#clip0_2_1860)">
                  <path
                    ...
                    fill=""
                    className={`${
                      card === "search" ? "fill-background" : "fill-foreground"
                    }`}
                  />
                  <path
            ...
            <button
              onClick={() => setCard("people")}
              className={`place-items-center grid rounded-[8px] lg:rounded-[12px] w-8 md:w-10 lg:w-12 h-8 md:h-10 lg:h-12 cursor-pointer ${
                card === "people" ? "bg-foreground" : "bg-background"
              }`}
            >
              <svg
                className="w-5 lg:w-6"
              ...
              >
                <path
                  ...
                  fill=""
                  className={`${
                    card === "people" ? "fill-background" : "fill-foreground"
                  }`}
                />
                <path
            ...
            <button
              onClick={() => setCard("store")}
              className={`place-items-center grid mb-12 rounded-[8px] lg:rounded-[12px] w-8 md:w-10 lg:w-12 h-8 md:h-10 lg:h-12 cursor-pointer ${
                card === "store" ? "bg-foreground" : "bg-background"
              }`}
            >
              <svg
                className="w-5 lg:w-6"
              ...
              >
                <path
                  ...
                  fill=""
                  className={` ${
                    card === "store" ? "fill-background" : "fill-foreground"
                  }`}
                />
                <path
            ...
            <button
              ...
              className={`bottom-4 left-[50%] absolute place-items-center grid rounded-[8px] lg:rounded-[12px] w-8 md:w-10 lg:w-12 h-8 md:h-10 lg:h-12 translate-x-[-50%] cursor-pointer ${
                card === "profile" ? "bg-foreground" : "bg-background"
              }`}
            >
              <svg
                className="w-5 lg:w-6"
              ...
              >
                <path
                  ...
                  fill=""
                  className={` ${
                    card === "profile" ? "fill-background" : "fill-foreground"
                  }`}
                />
                <path
          ...
          {card === "home" ? (
            ...
            <div className="relative flex gap-2 overflow-hidden gallery">
              {/* filter */}
              <div
                className={`top-4 sm:top-0 z-20 lg:static absolute bg-background/90 backdrop-blur-lg shadow-lg lg:shadow-none shadow-border border border-border rounded-[8px] lg:rounded-[12px] lg:max-w-[371px] shrink-0 transition-all duration-300 ${
            ...
            <div className="w-full">
              <h4 className="text-xl">Bookmark</h4>
              <p className="my-7">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nobis
                sequi corrupti consequatur tenetur blanditiis aspernatur
                distinctio esse dolorem veniam provident! Quos fugit odit quae
                neque exercitationem consequatur excepturi, aut, impedit eaque
                omnis eos tempora quo cum numquam corporis accusamus facere,
                laborum rerum vitae autem quod temporibus. Aliquam ipsam
                delectus officia iusto quo nobis provident, molestias
                accusantium dolore. Atque mollitia ab culpa! Reiciendis
                consequuntur repellat sint quos magni totam nam ullam
                praesentium esse facere. Facilis necessitatibus quod placeat
                nostrum ducimus expedita nemo aperiam dicta doloribus deserunt
                nisi eveniet culpa tempore fugit, fugiat odit repellat commodi
                libero asperiores sequi in iste sint. Praesentium neque sit
                facilis architecto repellendus blanditiis labore deleniti dolor,
                est, quidem consectetur unde molestias perspiciatis soluta vel
                fugit, sapiente error maxime provident consequatur delectus
                cumque fugiat? Consequatur!
              </p>
            </div>
          ) : card === "profile" ? (
            <div className="w-full">
              <div className="mx-auto p-6 max-w-2xl">
                <h2 className="mb-4 font-bold text-2xl">Benfort User Info</h2>
                <div className="shadow mb-6 p-4 border rounded">
                  <p>
                ...
                <div className="font-semibold text-right">
                  Total Saved Value: ${totalValue.toLocaleString()}
                </div>
              </div>
            </div>
          ) : null}
